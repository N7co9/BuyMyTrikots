...
class DependencyProvider
{
    public function provide(Container $container): void
    {
        ...
        $container->set(BasketRepository::class, new BasketRepository($container->get(UserRepository::class), $container->get(ApiMapper::class), $container->get(SqlConnector::class), $container->get(ApiCache::class), $container->get(SessionHandler::class)));
        ...
        $container->set(BasketManipulator::class, new BasketManipulator($container->get(SessionHandler::class), $container->get(UserRepository::class), $container->get(BasketEntityManager::class)));
        $container->set(BasketBusinessFacade::class, new BasketBusinessFacade($container->get(BasketManipulator::class), $container->get(TotalManipulator::class), $container->get(BasketRepository::class)));
        $container->set(OrderRepository::class, new OrderRepository($container->get(BasketBusinessFacade::class), $container->get(BillingMapper::class), $container->get(SqlConnector::class), $container->get(UserRepository::class), $container->get(SessionHandler::class)));
        $container->set(OrderBusinessFacade::class, new OrderBusinessFacade($container->get(OrderRepository::class)));
        $container->set(OrderItemProvider::class, new OrderItemProvider($container->get(BasketRepository::class)));
        $container->set(OrderEntityManager::class, new OrderEntityManager($container->get(UserRepository::class), $container->get(SqlConnector::class), $container->get(BasketBusinessFacade::class), $container->get(OrderItemProvider::class)));
